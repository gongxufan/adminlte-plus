        ...
        consts: {
            ...
            var e = {
                setting: d, addNodes: function (a, b, c, e) {
                    ...
                    var that = this;
                    $(this).confirm({msg: d.edit.deleteConfirmText}).on(function (e) {
                        if (e) {
                            a && (b = !!b, b && j.apply(d.callback.beforeRemove, [d.treeId, a], !0) == !1 || (i.removeNode(d, a), b && that.setting.treeObj.trigger(f.event.REMOVE, [d.treeId, a])))
                        }
                    });

                },removeNodeDirect: function (a, b) {
                    var that = this;
                    a && (b = !!b, b && j.apply(d.callback.beforeRemove, [d.treeId, a], !0) == !1 || (i.removeNode(d, a), b && that.setting.treeObj.trigger(f.event.REMOVE, [d.treeId, a])))
